...
part 'get_mtos_controller.g.dart';

@riverpod
class GetMtosController extends _$GetMtosController {
  final limit = 50;
...
@riverpod
class GetMtosPagination extends _$GetMtosPagination {
  @override
  set state(AsyncValue<bool> value) => super.state = value;

  @override
  AsyncValue<bool> build() {
    final data = ref.watch(getMtosControllerProvider);

    switch (data) {
      case AsyncError(:final error, :final stackTrace):
        return AsyncError(error, stackTrace);
      case AsyncData():
        final notifier = ref.read(getMtosControllerProvider.notifier);
